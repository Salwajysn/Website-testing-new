...
$sql = "SELECT * FROM materi WHERE Id_Kelas = '$id_kelas' LIMIT 4, 1"; // Ambil baris kelima (indeks 4) untuk halaman ui5.php
...
<head>
    ...
    <style>
        .tandai-selesai {
            ...
            margin-top: 0px;
            margin-bottom: 100px; /* Jarak dari bawah */
            margin-left: 60px;
...
<header>
    ...
    <div class="progresWrap">
        <div class="progress-container">
            <div class="progress-bar" style="width: 100%;"></div> <!-- Persentase 100% -->
        </div>
...
<main>
    ...
    <button id="mulaiQuizButton">Mulai Quiz</button>
    </section>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Mengarahkan ke halaman quizUI.php saat tombol diklik
        document.getElementById('mulaiQuizButton').addEventListener('click', function() {
            window.location.href = 'quizUI.php';
        });
    });
    </script>
