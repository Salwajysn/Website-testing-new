...
<header>
    ...
    <div class="progresWrap">
        <div class="progress-container">
            <div class="progress-bar" style="width: 20%;"></div> <!-- Persentase awal 20% -->
        </div>
...
<main>
    ...
    <section class="mulaiQuiz">
        <!-- Tombol Next yang mengarah ke halaman ui2.php -->
        <button class="next-button" onclick="window.location.href='ui2.php'">Next</button>
    </section>
