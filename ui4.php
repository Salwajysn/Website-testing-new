...
$sql = "SELECT * FROM materi WHERE Id_Kelas = '$id_kelas' LIMIT 3, 1"; // Ambil baris keempat (indeks 3) untuk halaman ui4.php
...
<header>
    ...
    <div class="progresWrap">
        <div class="progress-container">
            <div class="progress-bar" style="width: 80%;"></div> <!-- Persentase 80% -->
        </div>
        <p class="progress-score">80%</p>
...
<main>
    ...
    <section class="mulaiQuiz">
        <!-- Tombol Next yang mengarah ke halaman ui5.php -->
        <button class="next-button" onclick="window.location.href='ui5.php'">Next</button>
    </section>
</main>
</body>
</html>
