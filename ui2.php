...
$sql = "SELECT * FROM materi WHERE Id_Kelas = '$id_kelas' LIMIT 1, 1"; // Ambil baris kedua (indeks 1) untuk halaman ui2.php
...
<main>
    ...
    <section class="mulaiQuiz">
        <!-- Tombol Next yang mengarah ke halaman ui3.php -->
        <button class="next-button" onclick="window.location.href='ui3.php'">Next</button>
    </section>
</main>
</body>
</html>
