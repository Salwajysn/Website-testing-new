...
$sql = "SELECT * FROM materi WHERE Id_Kelas = '$id_kelas' LIMIT 2, 1"; // Ambil baris ketiga (indeks 2) untuk halaman ui3.php
...
<header>
    ...
    <div class="progresWrap">
        <div class="progress-container">
            <div class="progress-bar" style="width: 60%;"></div> <!-- Persentase 60% untuk halaman ini -->
        </div>
        <p class="progress-score">60%</p>
...
<main>
    ...
    <section class="mulaiQuiz">
        <!-- Tombol Next yang mengarah ke halaman ui4.php -->
        <button class="next-button" onclick="window.location.href='ui4.php'">Next</button>
    </section>
</main>
</body>
</html>
